...
def add_additional_clinics():
    additional_clinics = [
        {
            "name": "Oasis Fertility",
            "cities": ["Mysore", "Mangalore", "Belgaum"],
            "state": "Karnataka",
        ...
        {
            "name": "Indira IVF",
            "cities": ["Hubli", "Mysore", "Belgaum", "Mangalore", "Davangere"],
            "state": "Karnataka",
    ...
    with app.app_context():
        clinics_added = 0
        for clinic_data in additional_clinics:
        ...
        db.session.commit()
        print(f"Successfully added {clinics_added} additional clinics.")

if __name__ == "__main__":
    add_additional_clinics()
